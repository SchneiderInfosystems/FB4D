...
program FS_Encrypted_Notes_VCL;
...
uses
  ...
  EyncryptedNotesFrm in 'EyncryptedNotesFrm.pas' {frmEncryptedNotes},
  SymCrypto in 'SymCrypto.pas';
...
begin
  ...
  Application.CreateForm(TfrmEncryptedNotes, frmEncryptedNotes);
  Application.Run;
end.
